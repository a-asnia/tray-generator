      ...
      <div style={{ width: 310, minWidth: 270, flex: "0 1 310px", padding: "18px 18px 30px", background: "#FDFDFE", borderRight: "1px solid #E4E9EF", overflowY: "auto", maxHeight: "100vh" }}>
        ...
        <div style={{ marginTop: 10, padding: "8px 10px 2px", borderRadius: 8, border: "1px solid #E4E9EF", background: "#FAFBFC" }}>
          ...
          <p style={{ fontSize: 11.5, color: "#8A97A8", margin: "0 0 8px", lineHeight: 1.45 }}>
            ...
            остаток; колонки делят ступени на отсеки. Бортик — высота стенок над полом своей
            ступени: большой бортик при низком уровне пола даёт глубокие ячейки. После
            применения горка живая: параметры меняют её сразу, уровень пола любой ячейки и
            число колонок можно править обычными редакторами — бортики пересчитаются сами,
            а новые колонки наследуют уровень ряда.
          </p>
        </div>
        </Collapse>
